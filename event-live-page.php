			...
			<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
				<div class="hp_artist_landing_info">
					...
					<div class="hp_al_get_tickets">
						<h2>Show Name Here is LIVE</h2>
						<a href="#" class="alp_red_tag">Watch The Virtual Show</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<div class="evc_chat">
					...
					<h3>Chat</h3>
					<div class="evc_chat_box"></div>
					<div class="evc_send">
						<input type="text" name="name" placeholder="Type your chat message...">
